...
namespace Pulumi.Formal
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/formalco";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Formal.version.txt");
    ...
    internal sealed class FormalResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public FormalResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
