...
class ResourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] technology: Technology of the Resource: supported values are `aws`, `bigquery`, `clickhouse`, `dynamodb`, `gcp`, `grpc`, `http`, `kubernetes`, `llm`, `mariadb`, `mcp`, `mongodb`, `mysql`, `postgres`, `rdp`, `redis`, `redshift`, `s3`, `snowflake`, `ssh`, `web`.
    ...
    def technology(self) -> pulumi.Input[_builtins.str]:
        """
        Technology of the Resource: supported values are `aws`, `bigquery`, `clickhouse`, `dynamodb`, `gcp`, `grpc`, `http`, `kubernetes`, `llm`, `mariadb`, `mcp`, `mongodb`, `mysql`, `postgres`, `rdp`, `redis`, `redshift`, `s3`, `snowflake`, `ssh`, `web`.
        """
