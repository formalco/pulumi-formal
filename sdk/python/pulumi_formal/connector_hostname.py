...
class ConnectorHostnameArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] private_key: The TLS private key for this hostname. It should be in PEM format and only be set if the hostname is not managed by Formal.
