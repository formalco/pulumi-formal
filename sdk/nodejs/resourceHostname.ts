 ...
 */
export class ResourceHostname extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceHostnameState, opts?: pulumi.CustomResourceOptions): ResourceHostname {
        return new ResourceHostname(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'formal:index/resourceHostname:ResourceHostname';

    /**
     * Returns true if the given object is an instance of ResourceHostname.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ResourceHostname {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ResourceHostname.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: ResourceHostnameArgs | ResourceHostnameState, opts?: pulumi.CustomResourceOptions) {
