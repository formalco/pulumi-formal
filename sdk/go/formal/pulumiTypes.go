...
// Formal OIDC integration audience requested from AWS STS.
func (o ProviderOidcAwsOutput) Audience() pulumi.StringOutput {
	return o.ApplyT(func(v ProviderOidcAws) string { return v.Audience }).(pulumi.StringOutput)
}
...
// Formal OIDC integration audience requested from AWS STS.
func (o ProviderOidcAwsPtrOutput) Audience() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProviderOidcAws) *string {
		if v == nil {
			return nil
		}
		return &v.Audience
