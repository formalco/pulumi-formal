...
func NewUser(ctx *pulumi.Context,
	...
	var resource User
	err := ctx.RegisterResource("formal:index/user:User", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUser(ctx *pulumi.Context,
	...
	var resource User
	err := ctx.ReadResource("formal:index/user:User", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// If the user is of type `machine`, this is an optional designation for the app that this user will be used for. Supported values are `metabase`, `tableau`, and `popsql`.
func (o UserOutput) AppType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *User) pulumi.StringPtrOutput { return v.AppType }).(pulumi.StringPtrOutput)
}
...
// If the user is of type `machine`, this is the access token (database password) of this user.
func (o UserOutput) MachineUserAccessToken() pulumi.StringOutput {
	return o.ApplyT(func(v *User) pulumi.StringOutput { return v.MachineUserAccessToken }).(pulumi.StringOutput)
}
