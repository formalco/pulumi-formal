...
import (
	...
	formal "github.com/formalco/terraform-provider-formal/provider" // Import the upstream provider

	"github.com/formalco/pulumi-formal/provider/pkg/version"
)
...
//go:embed cmd/pulumi-resource-formal/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-formal/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-formal/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "formal", formal.Provider(),
		...
		// convention is to have a function at "github.com/formalco/terraform-provider-formal/provider".New
		...
		PluginDownloadURL: "",
		Description:       "A Pulumi package for creating and managing formal cloud resources.",
		// category/cloud tag helps with categorizing the package in the Pulumi Registry.
		// For all available categories, see `Keywords` in
		// https://www.pulumi.com/docs/guides/pulumi-packages/schema/#package.
		Keywords:   []string{"formal", "category/cloud"},
		License:    "Apache-2.0",
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/formalco/pulumi-formal/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("formal_", mainMod,
