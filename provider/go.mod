...
require (
	github.com/formalco/terraform-provider-formal v4.14.11+incompatible
...
require (
	...
	buf.build/gen/go/formal/core/protocolbuffers/go v1.36.11-20260227064633-55a213ddd9df.1 // indirect
	...
	github.com/formalco/go-sdk/sdk/v2 v2.12.0 // indirect
