...
const owner = 'mokhtar@joinformal.com';

const decrypt = new formal.Policy('decrypt', {
    name: 'decrypt',
...
const maskEmails = new formal.Policy('mask_emails', {
    name: 'mask-email',
...
const rowLevelHashing = new formal.Policy('row_level_hashing', {
...
const blockDbWithFormalMessage = new formal.Policy('block_db_with_formal_message', {
...
const httpPreRequestNameHash = new formal.Policy('http_pre_request_name_hash', {
